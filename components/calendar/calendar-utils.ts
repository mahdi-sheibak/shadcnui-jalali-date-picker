...
import { addYears, startOfYear, subYears } from "date-fns-jalali";

export const START_YEAR_JALALI = subYearsJalali(
  startOfYearJalali(new Date()),
  12
);
export const END_YEAR_JALALI = addYearsJalali(
  startOfYearJalali(new Date()),
  12
);
