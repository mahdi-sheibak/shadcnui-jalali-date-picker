...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      `
        border-input ring-offset-background flex h-9 w-full items-center justify-between rounded-md border bg-transparent px-3 py-2 text-sm
  ...
  <SelectPrimitive.Item
    ...
    className={cn(
      `
        ...
        relative flex w-full cursor-default items-center rounded-sm py-1.5 ps-2 text-sm outline-none select-none
    ...
    {...props}
  >
    <span className={cn('flex h-3.5 w-3.5 items-center justify-center', 'absolute', dir === 'rtl' ? 'left-2' : 'right-2')}>
